        ...
        <div class="flex-center position-ref full-height">
            <?php if(Route::has('login')): ?>
                <div class="top-right links">
                    <?php if(Auth::check()): ?>
                        <a href="<?php echo e(url('/home')); ?>">Fiscalía</a>
                    <?php else: ?>
  ...
  dots[slideIndex-1].className += " active";
            ...
            <div class="content">
                ...
                <div class="links">
                    ...
                    <a href="<?php echo e(url('/')); ?>">Sucursales</a>
                    <a href="<?php echo e(url('/')); ?>">Directorio Medico</a>
                   <a href="<?php echo e(url('/')); ?>">Atención al Cliente</a>
                     <a href="<?php echo e(url('/dashboard')); ?>">Panel de Atención</a>
                ...
                <div class="links">
                   ...
                   <img src="images/maletin.png"  style="width:100px;height:100px;border:0;" />
                    ...
                    <img src="images/estetoscopio.png"  style="width:100px;height:100px;border:0;" />
                     ...
                     <a href="<?php echo e(url('/carepanel')); ?>">
